...
class YamlHandler(BaseHandler):
    ...
    def __init__(self):
        ...
        if not YAML_AVAILABLE:
            print("Warning: ruamel.yaml not available. Install with: pip install ruamel.yaml")
    ...
    def apply_change(self, path: str, content: str, start_line: int, end_line: int) -> bool:
        ...
        if not YAML_AVAILABLE:
            print("ERROR: ruamel.yaml not available. Install with: pip install ruamel.yaml")
            return False
        ...
        try:
            ...
            print(f"Error parsing original YAML: {e}")
            return False
        ...
        try:
            ...
            print(f"Error parsing YAML suggestion: {e}")
            return False
    ...
    def detect_conflicts(self, path: str, changes: List[dict]) -> List[dict]:
        ...
        for change in changes:
            try:
                yaml = YAML()
                data = yaml.load(change.get("content", "{}"))
    ...
    def _smart_merge_yaml(self, original: Any, suggestion: Any, start_line: int, end_line: int) -> Any:
