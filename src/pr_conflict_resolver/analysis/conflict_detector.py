...
class ConflictDetector:
    ...
    def detect_overlap(self, change1: Tuple[int, int, str, Dict[str, Any]], 
                      change2: Tuple[int, int, str, Dict[str, Any]]) -> Optional[str]:
        """Detect overlap between two changes."""
        start1, end1, content1, meta1 = change1
        start2, end2, content2, meta2 = change2
    ...
    def is_semantic_duplicate(self, change1: Tuple[int, int, str, Dict[str, Any]], 
                             change2: Tuple[int, int, str, Dict[str, Any]]) -> bool:
        """Check if two changes are semantically identical."""
        _, _, content1, _ = change1
        _, _, content2, _ = change2
    ...
    def detect_conflict_patterns(self, conflicts: List[Dict[str, Any]]) -> Dict[str, Any]:
