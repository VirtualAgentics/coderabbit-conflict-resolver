...
class PromptCache:
    ...
    The cache directory defaults to `~/.cache/pr-conflict-resolver/llm/` with user-only
    ...
    def __init__(
        ...
        Args:
            cache_dir: Directory path for cache storage
                (default: ~/.cache/pr-conflict-resolver/llm)
        ...
        if cache_dir is None:
            cache_dir = Path.home() / ".cache" / "pr-conflict-resolver" / "llm"
