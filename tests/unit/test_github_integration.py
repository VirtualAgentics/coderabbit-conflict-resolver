...
class TestGitHubCommentExtractor:
    ...
    @patch('pr_conflict_resolver.integrations.github.requests.Session.get')
    def test_fetch_pr_comments(self, mock_get):
    ...
    @patch('pr_conflict_resolver.integrations.github.requests.Session.get')
    def test_fetch_pr_metadata(self, mock_get):
    ...
    def test_filter_bot_comments_custom_bots(self):
    ...
    def test_extract_suggestion_blocks(self):
    ...
    def test_extract_suggestion_blocks_with_options(self):
    ...
    def test_get_comment_metadata(self):
