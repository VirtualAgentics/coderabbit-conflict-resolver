...
from pr_conflict_resolver import ConflictResolver, Change, Conflict, FileType
...
class TestConflictResolver:
    ...
    def test_normalize_content(self):
        ...
        content = "  line1  \n  line2  \n  \n  line3  "
        normalized = resolver._normalize_content(content)
        expected = "line1\nline2\nline3"
        assert normalized == expected
    
    def test_extract_changes_from_comments(self):
    ...
    def test_has_line_overlap(self):
    ...
    def test_classify_conflict_type(self):
    ...
    def test_assess_conflict_severity(self):
        ...
        # Syntax error fix
        syntax_change = Change(
            "test.py", 10, 15, "fix error", {}, "fp1", FileType.PYTHON
        )
    ...
    def test_resolve_pr_conflicts(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_analyze_conflicts(self, mock_extractor):
