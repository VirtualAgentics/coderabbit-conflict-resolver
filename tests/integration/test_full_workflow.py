...
class TestFullWorkflow:
    ...
    def test_analyze_conflicts_workflow(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_resolve_conflicts_workflow(self, mock_extractor):
        """Test the complete conflict resolution workflow."""
        # Mock GitHub extractor
        mock_extractor.return_value.fetch_pr_comments.return_value = [
            {
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_no_conflicts_workflow(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_multiple_file_conflicts(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_priority_based_resolution(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_error_handling(self, mock_extractor):
    ...
    @patch('pr_conflict_resolver.core.resolver.GitHubCommentExtractor')
    def test_different_configurations(self, mock_extractor):
