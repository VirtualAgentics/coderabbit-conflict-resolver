...
| **SR-02** | Secret detection before writes | `SecretScanner.scan_content()` | Unit tests, 25+ patterns |
...
```python
# json_handler.py:92-109 - Complete mediation example
...
| 8 | CWE-798 | Hard-coded Credentials | Secret detection | SecretScanner (25+ patterns) | ✅ |
...
```python
# secret_scanner.py:73-140 - 25+ patterns
SECRET_PATTERNS = [
